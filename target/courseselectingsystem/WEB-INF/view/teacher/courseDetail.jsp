...
<rapid:override name="content">
    ...
    <div style="margin:10px 15px 10px;">
        <div class="layui-input-block">
            ...
            <input type="text" id="search" class="layui-input" placeholder="请输入学号搜索" style="float:right; width:200px;">
        </div>
    </div>
        ...
        <c:if test="${paging.totalPage >=0}">
            ...
            <c:choose>
                <c:when test="${paging.totalPage==0}">
                    ...
                    <button class="layui-btn layui-btn-disabled" onclick="goPage(${paging.currentPage})">上一页</button>
                    <button class="layui-btn layui-btn-disabled" onclick="goPage(${paging.currentPage})">下一页</button>
                    <button class="layui-btn layui-btn-disabled" onclick="goPage(${paging.currentPage})">末页</button>
                </c:when>
